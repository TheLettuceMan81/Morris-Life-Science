...
const Home = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center">
      <header className="w-full bg-blue-600 text-white py-10 flex flex-col items-center">
      ...
      <section className="py-10 px-6 w-full max-w-6xl">
      ...
      <section className="py-10 px-6 w-full bg-white shadow-md">
        <h2 className="text-3xl font-bold text-blue-600 mb-6 text-center">
          Our Expertise
        </h2>
